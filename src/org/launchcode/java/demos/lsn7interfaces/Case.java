...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Oreos",0.50,new ArrayList<>(Arrays.asList("Chocolate","dairy","gluten")));
        Topping topping2 = new Topping("Cherrys",0.75,new ArrayList<>(Arrays.asList("red #5")));
        Topping topping3 = new Topping("Cookie Dough",1.25,new ArrayList<>(Arrays.asList("dairy","Chocolate")));
        Topping topping4 = new Topping("Caramel Syrup",1.50,new ArrayList<>(Arrays.asList("dairy")));
        Topping topping5 = new Topping("malted milk",0.25,new ArrayList<>(Arrays.asList("dairy")));
